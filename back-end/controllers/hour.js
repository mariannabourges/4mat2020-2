...
controller.listar = async (req, res) => {
    try {
        ...
        let dados = await Hour.find()
            .populate('course')          // Dados completos
            .populate('teacher', 'name email') // Só nome e email
...
controller.obterUm = async (req, res) => {
    ...
    let obj = await Hour.findById(id)
...
controller.atualizar = async (req, res) => {
    try {
        ...
        let obj = await Hour.findByIdAndUpdate(id, req.body)
...
controller.excluir = async (req, res) => {
    try {
        ...
        const id = req.body._id
        let obj = await Hour.findByIdAndDelete(id)
