...
controller.obterUm = async (req, res) => {
    ...
    let obj = await Teacher.findById(id)
...
controller.atualizar = async (req, res) => {
    try{
        ...
        //Busca o objeto pelo id e, encontrando-o, substitui o coteúdo por req.body
        let obj = await Teacher.findByIdAndUpdate(id, req.body)
...
controller.excluir = async (req, res) => {
    try{
        //Isolando o id para a exclusão
        const id = req.body._id
        let obj = await Teacher.findByIdAndDelete(id)
